...
parcelRegister("1wD0w", function(module, exports) {

$parcel$export(module.exports, "ESP32C2ROM", () => $11c709ab39243ed5$export$8ad31a2aa21b3abf);

var $7imrD = parcelRequire("7imrD");

var $l8zNB = parcelRequire("l8zNB");
class $11c709ab39243ed5$export$8ad31a2aa21b3abf extends (0, $7imrD.ESP32C3ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($l8zNB))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($l8zNB))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($l8zNB))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($l8zNB))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($l8zNB))).text;
    }
...
parcelRegister("l8zNB", function(module, exports) {
...
//# sourceMappingURL=esp32c2.d96a3f5e.js.map
