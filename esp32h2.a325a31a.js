...
parcelRegister("ftB3z", function(module, exports) {

$parcel$export(module.exports, "ESP32H2ROM", () => $b4464f1be7758146$export$2184cd7dbcdab15a);

var $6bB6F = parcelRequire("6bB6F");

var $2upLS = parcelRequire("2upLS");
class $b4464f1be7758146$export$2184cd7dbcdab15a extends (0, $6bB6F.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($2upLS))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($2upLS))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($2upLS))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($2upLS))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($2upLS))).text;
    }
...
parcelRegister("2upLS", function(module, exports) {
...
//# sourceMappingURL=esp32h2.a325a31a.js.map
